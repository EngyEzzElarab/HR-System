...
public class GetEmployeesUnderManagerDirectlyTests {
    ...
    @Test
    @DatabaseSetup("/dataset/getEmployeesUnderManagerDirectlyScenario.xml")
    @Transactional
    public void testGetEmployeesDirectlyUnderAManager() throws Exception {
        this.mockMvc.perform(get("/employees/managers/{id}", 10)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$").exists())
                .andExpect(jsonPath("$", hasSize(2)))
                .andExpect(jsonPath("$[0].managerId", is(10)))
                .andExpect(jsonPath("$[1].managerId", is(10)))
        ;
